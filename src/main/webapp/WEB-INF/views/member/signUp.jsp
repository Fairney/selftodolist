 ...
 <main class= "main-style">
    <section>
        <div class = "signUp-Title">
            <span class="signUp-Title-text">회원가입</span>
        </div>
    </section>
        
    <section>
        <form method = "post" action = "${contextPath}/member/signUp" onsubmit = "return invalidate()">
            <div class = "sign-Div">
                <div>
                <div class ="sign-Div-inner">
                    <div style = "border-bottom: 0px;"class = "signUp-inner-Title">
                      Self Todolist
                    </div>
                    <div>
                        <div>아이디: </div> 
                        <div class = "input-field"><input type = "text" name = "memberId" class = "sign_input" id ="memberIdInput"></div>
                        <div class="id_desc_div">
                          <span id = "id_desc" class = "id_desc"></span>
                        </div>
                    </div>
                    <div>
                        <div>비밀번호: </div> 
                        <div class = "input-field"><input type = "password" name = "memberPw" class = "sign_input" id = "memberPw"></div>
                        <div class="id_desc_div">
                          <span id = "pw_desc" class = "pw_desc"></span>
                        </div>
                    </div>
                    <div>
                        <div>비밀번호 확인: </div> 
                        <div class = "input-field"><input type = "text" name = "memberPwConfm" class = "sign_input" id="memberPwConfm"></div>
                        <div class="id_desc_div">
                          <span id = "pwfm_desc" class = "pwfm_desc"></span>
                        </div>
                    </div>
                    <div>
                      <div>닉네임: </div> 
                      <div class = "input-field"><input type = "text" name = "memberNick" class = "sign_input" id="memberNick"></div>
                      <div class="id_desc_div">
                        <span id = "nick_desc" class = "nick_desc"></span>
                      </div>
                  </div>
                    <div>
                        <div>이메일: </div> 
                        <div class = "input-field"><input type = "text" name = "memberEmail" class = "sign_input" id = "memberEmail"></div>
                        <div class="id_desc_div">
                          <span id = "email_desc" class = "nick_desc"></span>
                        </div>
                    </div>
                    <div>
                        <div>주소: </div>
                        <div>
                          <div class = "input-field">
                            <input type = "text" name = "memberAddr" onclick="sample6_execDaumPostcode()" class = "sign_input"readonly id = "sample6_postcode">
                          </div>
                            <div class = "input-field">
                                <input type = "text" name = "memberAddr" class = "sign_input" id = "sample6_address"readonly>
                            </div>
                            <div class = "input-field">
                                <input type="text" id="sample6_detailAddress" name="memberAddr" class = "sign_input" placeholder="상세주소">
                            </div>
                        </div>
                    </div>
                    <div style="border-bottom:0px; padding-top:180px;">
                    ...
                    <div class="form_content">
                        ...
                        <ul class="terms_list">
                          ...
                          <li class="terms_item">
                            ...
                            <label for="termsService4"><span class="option point">[선택]</span>
                            <div class="text_wrap">
